# Recall
Recall provides a library of classes useful for implementing the "write" side of a CQRS system (with event sourcing). It currently has service locators for most things to provide some degree of inversion of control, a memento-like repository for dealing with Aggregate Roots in a DDD-way, and several interfaces for adding your own Event routers and Event & Snapshot stores.
...
## Event-Sourcing
Building on top of CQRS, your write model could actually just be a sequence of all the events that happened to your domain model. This sequence would, in effect, become a perfect audit log of your system.
